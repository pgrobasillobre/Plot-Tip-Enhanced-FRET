#!/bin/bash
#PBS -l select=1:ncpus=96:mpiprocs=96:mem=400GB -q q14aurora -N 1-Zn-Pc
#######################################################################
...
contodir=pos-5
dovesono=/home/pgrobasillobre/calc/fret/tip-transfer/kong/tip-mols/fig-1d/freq-2.5_ev/tip-d5.0_angs/zn-pc/state-1
cd "${dovesono}"
...
## MODIFY EXECUTABLE NAME 
   ./zn-pc_cam-b3lyp_tzp.run > zn-pc_cam-b3lyp_tzp.log
