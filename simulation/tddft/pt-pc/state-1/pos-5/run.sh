#!/bin/bash
#PBS -l select=1:ncpus=96:mpiprocs=96:mem=400GB -q q07aurora -N 1-Pt-Pc
#######################################################################
...
contodir=pos-5
dovesono=/home/pgrobasillobre/calc/fret/tip-transfer/kong/tip-mols/fig-1d/freq-2.5_ev/tip-d5.0_angs/pt-pc/state-1
cd "${dovesono}"
